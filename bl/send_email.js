...
const sendTransferResultEmail = async (emailData) => {
  try {
    console.log('Enviando correo:', emailData);
    const transporter = nodemailer.createTransport({ ...smtpOptions });
    const { email, transferId, name, transferStatus } = emailData;
                    ...
                    >
                      ...
                      <tr>
                        <td class="content-cell">
                          <img
                            class="email-main-header-image"
                            src="https://res.cloudinary.com/cariasj/image/upload/v1683081339/Email_Headers_xpungg.png"
                            alt="transfer-result-illustration"
                          />
                          <div class="f-fallback">
                            ...
                            <p>Por favor, ingrese a su cuenta en la plataforma SICA para más detalles acerca de su solicitud. Si tiene alguna pregunta o inquietud, no dude en contactar a nuestro equipo de soporte.</p>
